...
* [OPTIONAL] attr_list.txt (text file containing the attributes we used in our CSV generation) [OPTIONAL]
-------------------------------------------------------------
...
Since the entire 311 data is over a million rows, we decided to sample the data within.
